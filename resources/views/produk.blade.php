    ...
    <div class="row">
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="{{ asset('images/7074f84a7522c1a7f5425e29054630ea.jpeg') }}" class="card-img-top" alt="VX9">
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="{{ asset('images/3e3aa11c49d25514c2839cdc5cb6274d_tn.jpeg') }}" class="card-img-top" alt="HX10">
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="{{ asset('images/67294240_2476043149294617_6789651617600160537_n.jpg') }}" class="card-img-top" alt="Keyboard K9SE">
                <div class="card-body">
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="{{ asset('images/id-11134207-7qul4-lgq28ygzyleza2.jpeg') }}" class="card-img-top" alt="Gaming Chair RGC103">
                <div class="card-body">

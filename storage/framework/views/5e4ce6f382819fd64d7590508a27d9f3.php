<?php $__env->startSection('content'); ?>
    <div class="text-center py-5" style="background: linear-gradient(to right, #e3f2fd, #ffffff); border-radius: 12px;">
        <img src="<?php echo e(asset('images/logo-rexus@2x.jpg')); ?>" alt="Logo Rexus" width="120" class="mb-3">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\llravel\PSAT\resources\views/home.blade.php ENDPATH**/ ?>